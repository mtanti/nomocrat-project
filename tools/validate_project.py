...
def main(
    ...
    check_init(nomocrat_project.path)

    check_docstrings_dir(os.path.abspath(os.path.join(nomocrat_project.path, '..', '..', 'tools')))
    check_docstrings_dir(os.path.abspath(os.path.join(nomocrat_project.path, '..', '..', 'bin')))
    check_docstrings_dir(nomocrat_project.path)
